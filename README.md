...
### 2.1. Course activities

The course consists of oral lectures, lab sessions and mini projects. The aim of the lab sessions is to show and reinforce how the ML models, explainable ML techniques and ML ideas presented in the oral lectures are put to practice. Also, they help students gather hands-on machine learning skills. The lab sessions involve a series of exercises in the form of Python notebooks.
...
Course activities:
- **Oral lectures:** Lecture sessions where core ML concepts, theories, and methodologies are presented.
- **Lab Sessions:** Not-graded, Hands-on programming exercises using Python Notebooks where you apply the concepts learned in lectures.
- **Mini projects:** Group-based research projects where you work on real ML applications.
- **Practical Exam:** A computer-based examination conducted in a controlled environment where you demonstrate your practical ML skills. You'll have access to completed lab sessions but no internet connection.
- **Final Exam:** Final examination covering all theoretical and practical aspects of the course.
...
|:----:|:-----:|----------:|-----------:|--------------:|-----------:|---------------:|-----------------------------------------------------------------------------------:|-----------:|
|  46  |   0.0   |           |            |               |            | Lab session    | L0: Basics of python and data analysis                                             | [Lab session 0](https://github.com/TPM034A/Q2_2025/blob/main/Lab_sessions/lab_session_00/lab_session_00.ipynb) |
|  46  |   1.1   | Monday    | 10-11-2025 | 15:45 - 17:45 | Sander     | Opening        | Learning Objectives, Set-up, Scope, Planning, Expectations; What is ML?            | |
|  46  |   1.2   | Wednesday | 12-11-2025 | 08:45 - 10:45 | Sander     | Oral lecture   | Learning, Generalisation, Model dev, Regression, Geospatial data                   | |
|  46  |   1.3   | Thursday  | 13-11-2025 | 08:45 - 10:45 | Francisco  | Lab session    | L01: Discover, explore and visualise data of liveability in the Netherlands        | [Lab session 1](https://github.com/TPM034A/Q2_2025/blob/main/Lab_sessions/lab_session_01/lab_session_01.ipynb)|
|  47  |   1.4   | Monday    | 17-11-2025 | 15:45 - 17:45 | Sander     | Oral lecture   | Decision trees; Model performance metrics                                          | |
|  47  |   1.5   | Wednesday | 19-11-2025 | 08:45 - 10:45 | Sander     | Oral lecture   | ANNs; training; tuning; k-fold                                                     | |
...
| 47   | Lab 2       | ✅ [Available](https://github.com/TPM034A/Q2_2025/blob/main/Lab_sessions/lab_session_02/lab_session_02.ipynb) | ⏳ 24-11-2025 08:30 |
...
We use the [Issues](https://github.com/TPM034A/Q2_2025/issues) section as the Q&A platform of this course. Here, you can post your questions related to the content of the lectures, the lab sessions and technical problems with Python. Before you create a new issue, please make sure the issue has not been raised before by one of your classmates. Besides asking questions, you can comment on the earlier issues e.g. to continue the discussion. As an example, we have already created the first issue; see [Issues](https://github.com/TPM034A/Q2_2025/issues).
...
In this course, lab sessions will require programming in Python. You’ll need to prepare your computer by installing and setting up essential software in order to complete this course. Specifically, you will need a Python interpreter and a code editor. The interpreter allows your computer to run Python code, and it can be installed directly from Python’s website or through third-party software like Conda or Anaconda. The code editor is where you’ll write and execute Python scripts and notebooks; examples include VS Code, PyCharm or JupyterLab.

We offer instructions for two different setup options: (1) Anaconda, and (2) Google Colab. While you can do the activities with both, we strongly recommend Anaconda. Additionally, for those with advanced experience in managing Python versions and environments, we also provide the `requirements.txt` ([file](https://github.com/TPM034A/Q2_2025/requirements2025.txt)) file for you to create the respective environment. If you choose this method, ensure you create a virtual environment with Python version 3.12.11 for compatibility. This option is intended for students comfortable with Python’s native package manager, PIP, command line, and manual environment setup.
 ...
 * Download Anaconda for your system:
    - [Windows](https://repo.anaconda.com/archive/Anaconda3-2025.06-0-Windows-x86_64.exe)
    - [Mac (silicon)](https://repo.anaconda.com/archive/Anaconda3-2025.06-0-MacOSX-arm64.pkg)
    - [Mac (intel)](https://repo.anaconda.com/archive/Anaconda3-2025.06-0-MacOSX-x86_64.pkg)
